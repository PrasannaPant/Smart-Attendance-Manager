...
//TO CREATE STUDENT DETAILS TABLE
...
$s=$dbo->conn->prepare($c);    //PREPARE THE SQL STATEMENT USING PDO CONNECTION($c stores the sql command)
try{
$s->execute();                //EXECUTE THE SQL STATEMENT($s stores the prepared statement)
...
//TO CREATE COURSE DETAILS TABLE
...
//TO CREATE FACULTY DETAILS TABLE
...
//TO CREATE SESSION DETAIL TABLE
...
//TO CREATE COURSE ALLOTMENT RELATION TABLE
...
//TO CREATE ATTENDANCE RELATION TABLE
...
//INSERTING IN THE DATABASE TABLES:-
...
values
  ...
  clearTable($dbo,"course_registration");  //if any record already there in the table delete them

//FILLING VALUES IN COURSE ALLTOMENT TABLE FOR STUDENTS RANDOMLY
...
//FILLING VALUES IN COURSE ALLTOMENT TABLE FOR FACULTY RANDOMLY
