...
if(isset($_REQUEST['action']))
{
    ...
    if($action=="getSession")            //RETRIVES THE SESSION FROM THE DATABASE
    {
         $dbo=new Database();
    ...
    if($action=="getFacultyCourses")     //RETRIVES COURSES TAKEN BY FACULTY MEMBERS IN A SESSION
    {
         $facid=$_POST['facid'];
    ...
    if($action=="getStudentList")         //RETRIVES STUDENTS ENROLLED IN A COURSE IN A SESSION
    {
