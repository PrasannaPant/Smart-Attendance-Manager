...
class attendanceDetails
{
     ...
     //THIS FUNCTION UPDATES THE ATTENDANCE RECORD IN ATTENDANCE_DETAILS TABLE
     {
        $rv=[-1];
     ...
     //THIS FUNCTION RETRIVES A LIST OF STUDENTS MARKED PRESENT FOR A SPECIFIC CLASS SESSION DATE.
     {
        $rv=[];
     ...
     //THIS FUNCTION GENERATES REPORT FOR A SPECIFIC SESSION AND COURSE
     {
        $report=[];
        $sessionName='';
        $facname='';
